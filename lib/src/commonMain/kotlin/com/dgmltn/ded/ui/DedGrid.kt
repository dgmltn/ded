...
fun DedGrid(
    ...
    colors: DedColors = DedColors.Default  //TODO: LocalDefaults.current.editor
) {
    ...
    Box(
        ...
        CompositionLocalProvider(
            ...
            scope.AllVisibleGlyphs(state.length, state::getCharAt, state::getColorOf, state.cursorPos, state.selection)
        }
    }
}
